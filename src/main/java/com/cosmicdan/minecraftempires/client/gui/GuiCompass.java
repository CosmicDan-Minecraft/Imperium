...
public class GuiCompass extends Gui {
    ...
    public GuiCompass(Minecraft mc) {
      super();
      this.mc = mc;
      this.compassTexture = new ResourceLocation("minecraftempires:textures/gui/compass_1.png");
      this.compassTextureMask = new ResourceLocation("minecraftempires:textures/gui/compass_1_mask.png");
    }
