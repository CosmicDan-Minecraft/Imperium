...
public class GuiLog extends GuiScreen {
    static final ResourceLocation texture = new ResourceLocation("imperium4x:textures/gui/playerlog.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float renderPartials) {
        ...
        EventLogBuilder playerEvents = new EventLogBuilder(ImperiumPlayer.get(player));
