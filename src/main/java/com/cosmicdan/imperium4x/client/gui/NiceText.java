...
public class NiceText {
    ...
    public int drawDayHeader(Minecraft mc, GuiScreen gui, int drawX, int drawY, int age, int day) {
        ...
        mc.renderEngine.bindTexture(new ResourceLocation("imperium4x:textures/gui/playereventlist_numbers_" + age + ".png"));
    ...
    private ResourceLocation getDayTextureForLang(String lang, int age) {
        ...
        return new ResourceLocation("imperium4x:textures/gui/" + lang + "/playereventlist_day_" + age + ".png");
    }
}
