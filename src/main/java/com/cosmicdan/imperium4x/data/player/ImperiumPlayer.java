...
import com.cosmicdan.imperium4x.server.SyncEvents;
...
public class ImperiumPlayer implements IExtendedEntityProperties {
    
    public final static String EXT_PROP_NAME = "ImperiumPlayer";
    ...
    public ImperiumPlayer(EntityPlayer player) {
        this.player = player;
    }
    
    public static final void register(EntityPlayer player) {
        player.registerExtendedProperties(ImperiumPlayer.EXT_PROP_NAME, new ImperiumPlayer(player));
    }
    
    public static final ImperiumPlayer get(EntityPlayer player) {
        return (ImperiumPlayer) player.getExtendedProperties(EXT_PROP_NAME);
    }
